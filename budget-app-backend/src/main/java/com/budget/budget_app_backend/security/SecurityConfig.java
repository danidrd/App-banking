package com.budget.budget_app_backend.security;
...
public class SecurityConfig {
    ...
    /**
     * Configurazione CORS: serve all'app mobile (Capacitor), che gira su
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                // Abilita il filtro CORS di Spring Security, che gestisce anche
                // le richieste di preflight (OPTIONS) PRIMA dei controlli di
                // autenticazione: senza, i preflight fallirebbero con 403
                // perché non portano il token.
                .cors(Customizer.withDefaults())
                // API stateless senza cookie di sessione: il CSRF (pensato per
                // difendersi da richieste involontarie del browser con sessione
                // attiva) qui non si applica.
